## sick_visionary_ros (noetic) - 1.1.2-1
...
```
cd existing_repo
git remote add origin https://gitlab.sickcn.net/GBC09/bu05/development/systemintegration/cppbased/sick_visionary_ros-release.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.sickcn.net/GBC09/bu05/development/systemintegration/cppbased/sick_visionary_ros-release/-/settings/integrations)
